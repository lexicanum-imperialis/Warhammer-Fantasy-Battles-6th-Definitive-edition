  ...
  <sharedSelectionEntries>
    ...
    <selectionEntry type="upgrade" import="true" name="Swedish Comp System" hidden="false" id="7fd2-3000-523b-3bc2">
      ...
      <selectionEntryGroups>
        <selectionEntryGroup name="Generic" id="02c8-b969-af34-6856" hidden="false">
          <selectionEntries>
            <selectionEntry type="upgrade" import="true" name="Magic Capacity" hidden="false" id="243d-1c28-19dc-41a5">
                ...
                <selectionEntry type="upgrade" import="true" name="Power Stone" hidden="false" id="cbaf-e79c-c4d5-dcbd" sortIndex="3">
                  ...
                  <modifiers>
                    ...
                    <modifier type="increment" value="2" field="2db8-4138-44f2-f6eb">
                      <repeats>
                        <repeat value="1" repeats="1" field="selections" scope="roster" childId="696a-648d-c842-4c6a" shared="true" roundUp="false" includeChildSelections="true" includeChildForces="true"/>
                      </repeats>
                    </modifier>
                  </modifiers>
                </selectionEntry>
                <selectionEntry type="upgrade" import="true" name="Dispell Scrolls" hidden="false" id="5f46-2400-989f-fe70" sortIndex="2">
                  ...
                  <modifiers>
                    ...
                    <modifier type="increment" value="2" field="410e-ed97-ecf8-cfa4">
                      <repeats>
                        <repeat value="1" repeats="1" field="selections" scope="roster" childId="b76c-6bad-4650-dbb0" shared="true" roundUp="false" includeChildSelections="true" includeChildForces="true"/>
                      </repeats>
                    </modifier>
                  </modifiers>
                </selectionEntry>
              ...
              <rules>
                <rule name="Magic Capacity (General)" id="07f1-8230-1b13-0f0a" hidden="false">
                  <description>### Magic Capacity
For determining the AC given by the army’s Magic Capacity, add together the following: 
- The ”free” number of dice the army generates (2 Power Dice and 2 Dispel Dice for most armies, but 4  Dispel Dice for Dwarfs etc) 
- The number of Power Dice/Dispel Dice generated by characters every magic phase. 
- Each bound item (not one-use only items) present in the army list adds one Power Die for this  purpose. This also applies to for example The Corpse Cart. 
- Characters and units able to use Bound Spells also count as generating Power Dice, but exactly how  many are described in the lists below (specific for each army). 
- Items/Units that generate Power Dice or Dispel Dice are also included*. 
- Other items mentioned in the restricted items list may also count as power or dispel dice. 
- Tomb King armies and Empire armies with only priests count their Basic Power Dice as 0 (zero)  instead of 2.  
- 1st Dispel Scroll counts as a dispel dice
Each Dispel Scroll &gt;1 counts as two dispel dice
1st Power Stone counts as a power dice
Each Power Stone &gt;1 counts as two power dice 

Calculate Power Dice and Dispel Dice separately, then consult the table below and add the two numbers to 
get the total Bonus/Penalty for Magic Capacity: 
...
| 9| -550 |
| 10| -800 |
- -300 per extra dice over 10 

If you have both 2 dispel and 2 power dice you receive a extra +200 bonus (This does NOT apply to Deamons Of Chaos) 

**Example:** An army with one level 4 wizard will generate 6 Power and 4 Dispel Dice. The army also includes a Power Familiar (1 Power and 1 Dispel) as well as two Mark of Tzeentch (2 Power Dice). The total is then 9 power and 5 dispel dice. The table is consulted: 9 Power Dice gives a penalty of 550 while 5 Dispel Dice sets you back another 50 points. The total Army Composition points for Magic Capacity is thus -600. 
* Items that generate a random number of Power or Dispel Dice count as generating the average number of dice for this purpose, rounded up. For example: Banner of Sorcery would generate 2 PD due to the randomness of D3 Power Dice generated in the owner&apos;s Magic Phase. 

NOTE: Items that can store Power Dice or Dispel Dice are NOT included in this calculation, but might be punished in the &quot;Restricted Magic Items&quot; section instead.</description>
                </rule>
              </rules>
            </selectionEntry>
          </selectionEntries>
...
- (FC) Denotes the bonus rewarded is worth either:
    1. Equal to the points cost of the unit without a “standard bearer” OR
    2. Double the points cost of the unit with a “standard bearer”. To receive the double points for a “FC” you must take the available upgrade (e.g. Standards).
