# 📜 Warhammer Fantasy Battles (6th Edition): Official Army Books Errata

This document serves as the definitive digital ledger for the official Games Workshop Army Book Errata for Warhammer Fantasy Battles 6th Edition. It contains only the unedited, historically accurate corrections to the printed faction books as published by the original design team (e.g., Warhammer Chronicles 2004). 

*Disclaimer: This file serves as the primary unalterable truth baseline for the engine's data files. No community FAQs or digital resolutions are housed in this directory.*
